...
export class Init1758808907518 implements MigrationInterface {
    name = 'Init1758808907518'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "food_recipes" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "ingredient" character varying NOT NULL, "instruction" character varying NOT NULL, "image_url" character varying NOT NULL, "avgRating" double precision NOT NULL DEFAULT '0', "ratingCount" integer NOT NULL DEFAULT '0', "difficulty_id" integer, "cooking_duration_id" integer, "username" character varying, CONSTRAINT "PK_d44deb7b1c53965cb5cb044295a" PRIMARY KEY ("id"))`);
